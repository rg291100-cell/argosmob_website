    ...
    <>
      ...
      <section className="relative pt-32 pb-20 bg-slate-950 overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/images/ai-renders/web-dev.webp')",
      ...
      {/* Filter Bar — sticks to the viewport top; the navbar auto-hides on
          scroll-down, so a fixed 68px offset would leave a floating gap */}
            ...
            <div className="flex items-center gap-2">
              {categories.map((cat) => (
                <button
                  ...
                  className={cn(
                    "px-4 py-1.5 rounded-full text-sm font-semibold whitespace-nowrap transition-all duration-300",
                    activeCategory === cat 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {loading ? (
            <div className="flex flex-col items-center justify-center py-40 gap-4">
              ...
              <p className="text-slate-500 text-sm font-medium">Fetching portfolio...</p>
            </div>
                    ...
                    <div className="group bg-white rounded-3xl border border-slate-200 overflow-hidden hover:shadow-3xl hover:shadow-slate-200/50 transition-all duration-500 flex flex-col h-full">
                      ...
                      <div className="relative h-[300px] sm:h-[400px] overflow-hidden">
                        ...
                        <div className="absolute top-6 left-6 flex flex-wrap gap-2">
                          <span className="px-3 py-1 bg-white/10 backdrop-blur-md border border-white/20 text-white text-xs font-bold uppercase tracking-wider rounded-lg">
                            {project.category}
                          </span>
                        </div>
                      ...
                      <div className="p-8 flex flex-col flex-1">
                        <div className="grid grid-cols-2 gap-4 mb-8 border-b border-slate-100 pb-6">
                           ...
                           <div>
                              <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">Year</p>
                        ...
                        <div className="mt-auto">
                          <div className="flex flex-wrap gap-2 mb-8">
                            {project.tech_stack?.map((tech: string) => (
                              <span key={tech} className="px-3 py-1.5 bg-slate-50 text-slate-600 rounded-xl text-xs font-bold border border-slate-100">
                                {tech}
                              </span>
                            ))}
                          </div>

  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          backgroundImage: "url('/images/ai-renders/hero-dashboard.png')",
        ...
        <div className="grid lg:grid-cols-2 gap-16 xl:gap-24 items-center">
          ...
          <div>
            ...
            >
              ...
              <div className="status-live text-[11px]">Live</div>
            </motion.div>
            ...
            <motion.p
              ...
              className="text-[1.0625rem] leading-[1.75] text-slate-400 max-w-lg mb-10"
            >
            ...
            >
              {[
                ...
                <div key={text} className="flex items-center gap-2 text-[13px] text-slate-400">
          ...
          >
                ...
                <div className="grid grid-cols-3 gap-2.5 mb-3">
                  {METRICS.map((m) => (
                    ...
                    >
                      ...
                      <p className="font-bold text-[13px]" style={{ color: m.color }}>{m.value}</p>
                ...
                <div className="space-y-2">
                  {ACTIVITY.map((a, i) => (
                    ...
                    >
                      ...
                      <span className="text-[11px] text-slate-400 flex-1">{a.text}</span>
            ...
            >
              <div className="flex items-center gap-2.5 mb-2">
                ...
                <div>
                  <p className="text-[11px] text-white font-semibold">AI Integration</p>
            ...
            >
              ...
              <p className="text-[13px] text-white font-bold">42 sessions</p>

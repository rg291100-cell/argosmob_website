      ...
      <div className="container-xl">
        <div className="grid lg:grid-cols-2 gap-16 xl:gap-24 items-center">
          ...
          >
            ...
            <p className="text-[1.0625rem] text-slate-500 leading-relaxed mb-9">
            ...
            <div className="space-y-4 mb-10">
              {bullets.map((point, i) => (
                ...
                >
                  ...
                  <span className="text-slate-600 text-[14.5px]">{point}</span>
                </motion.div>
              ))}
            </div>
            ...
            <div className="flex items-center gap-4 flex-wrap">
              {[
                ...
                <div
                  key={badge.label}
                  className="px-4 py-2 rounded-full text-[12px] font-semibold text-blue-700 border border-blue-100"
            ...
            {reasons.map((reason, i) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-semibold text-slate-900 text-[14px] mb-1.5">{reason.title}</h3>
                  <p className="text-[12.5px] text-slate-500 leading-relaxed">{reason.description}</p>

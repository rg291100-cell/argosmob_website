...
export default function InteractiveTile({
  ...
  return (
    ...
    >
      ...
      {/* 80% Image Area */}
      <div 
        className={cn("relative w-full overflow-hidden bg-slate-50/50 flex items-center justify-center transition-all duration-500 border-b border-slate-100", isExpanded ? "h-48" : imageHeight)}

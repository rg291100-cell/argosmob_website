...
// Anchors match the per-service section ids generated on /services from CMS titles;
// unknown anchors degrade gracefully to the top of the services page.
const services = [
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-14">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-3 mb-6 group">
              ...
              <div>
                <div className="font-bold text-white leading-none text-base">ArgosMob</div>
                <div className="text-[9px] font-bold text-blue-400 tracking-[0.18em] uppercase mt-0.5">Tech & AI</div>
              </div>
            </Link>

            <p className="text-slate-400 text-sm leading-[1.75] mb-6 max-w-xs">
          ...
          {/* Services */}
          <div>
            <h3 className="text-xs font-bold text-slate-400 uppercase tracking-[0.15em] mb-5">Services</h3>
            <ul className="space-y-3">
              {services.map((s) => (
                <li key={s.label}>
                  <Link
                    href={s.href}
                    className="text-slate-400 text-sm hover:text-blue-400 transition-colors duration-200 animated-underline"
                  >
                    {s.label}
                  </Link>
                </li>
          ...
          {/* Company */}
          <div>
            <h3 className="text-xs font-bold text-slate-400 uppercase tracking-[0.15em] mb-5">Company</h3>
            <ul className="space-y-3">
              {company.map((c) => (
                <li key={c.label}>
                  <Link
          ...
          {/* Contact */}
          <div>
            <h3 className="text-xs font-bold text-slate-400 uppercase tracking-[0.15em] mb-5">Contact</h3>
            <ul className="space-y-4 mb-6">
              <li className="flex items-start gap-3">
                ...
                <a 
                  ...
                  className="text-slate-400 text-sm leading-snug hover:text-blue-400 transition-colors"
                >
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:hello@argosmob.onmicrosoft.com" className="text-slate-400 text-sm hover:text-blue-400 transition-colors">
                  hello@argosmob.onmicrosoft.com
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Phone size={14} className="text-blue-500 flex-shrink-0" />
                <a href="tel:+917042603342" className="text-slate-400 text-sm hover:text-blue-400 transition-colors">
                  +917042603342
                </a>
              </li>
            </ul>
            ...
            >
              <p className="text-xs text-slate-400 mb-1.5 uppercase tracking-wider font-semibold">WhatsApp</p>
              <a
                href="https://wa.me/917042603342"
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm font-semibold text-green-400 hover:text-green-300 transition-colors flex items-center gap-2"
              >
